    ...
    <div class="container-xl">
        <div class="konto-container">
            ...
            <div class="konto-body">
                    ...
                    <table class="bestelldetails-table">
                        <thead>
                            <tr>
                                ...
                                <th class="td-status">Gesamtsumme</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="td-details"><a href="page-konto-2-1.php" class="button-dark button-detail">Anzeigen</a></td>
                            </tr>
                            <tr>
                                <td class="td-bestellung"><a href="#">#EM4198</a></td>
                                <td class="td-datum">10. August 2021</td>
                ...
                <div class="bestelldetails-body">
                    <div class="bestelldetails-item">
                        <div class="bestelldetails-details">
                            <div class="bestelldetails-row">
                                <div class="bestelldetails-row__name">
                                    Bestellung
                                </div>
                                <div class="bestelldetails-row__info">
                                    <a href="#">#EM4198</a>
                                </div>
                            </div>
                            <div class="bestelldetails-row">
                            ...
                            <div class="bestelldetails-row">
                                ...
                                <div class="bestelldetails-row__info">
                                    <a href="#">CHF 25.00</a> für 4 Artikel
                                </div>
                            </div>
                        </div>
                        <div class="bestelldetails-anzeigen">
                            <a class="button-link button-anzeigen" href="page-konto-2-1.php">Details anzeigen</a>
                        </div>
                    </div>
