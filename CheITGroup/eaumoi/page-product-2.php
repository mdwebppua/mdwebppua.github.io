...
<head>
    ...
    <title>Product Geschenkbox Glas - eaumoi</title>
    ...
    <div class="container-xl">
        ...
        <div class="product-details">
            <div class="prdetails-thumb">
                <img src="img/product/glas-details.png" alt="">
            </div>
            <div class="prdetails-info">
                ...
                <div class="prdetail-about">
                    <ul class="prdetail-list">
                        <li>• Von jeder der 4 Geschmackssorten je 2 Sachets (für je ca. 600 ml)</li>
                        <li>• Gutschein für den Bezug von 5 weiteren Fruchtpürees</li>
                        <li>• Hochwertige Borosilikat-Trinkflasche (600 ml)</li>
                        <li>• Personalisierte Grusskarte</li>
                        <li>• Stilvolle Geschenkbox</li>
                    </ul>
                </div>
            </div>
        </div>
