...
<section class="deckel-page">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 deckel-stepline">
                <ul class="konfigurieren-stepline">
                    <li class="active"><span>Vorlage wählen</span></li>
                    <li><span>Anpassen</span></li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-7 deckel-list">
                <div class="row">
                    <div class="col-md-4">
                        <div class="deckel-short">
                            <div class="deckel-short__thumb">
                                img
                            </div>
                            <div class="deckel-short__name">
                                Name
                            </div>
                        </div>
                    </div>
        ...
        <div class="deckel-buttonbox">
            <button class="button deckel-button">
                Weiter
            </button>
        </div>
    </div>
