                ...
                <div class="row">
                    <div class="col-12">
                        <ul class="konfigurieren-stepline">
                            <li class="active"><span>Menge</span></li>
                            <li><span>Geschmack</span></li>
                            <li><span>Zusammenfassung</span></li>
                        </ul>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6 konfigurieren-stepcol">
                        <div class="konfigurieren-stepitem">
                            ...
                            <div class="konfigurieren-stepform">
                                <div class="konfigurieren-steptype">
                                    <label class="konfigurieren-steptype__radio">
                            ...
                            <div class="konfigurieren-stepinfo">
                                ...
                                1 Beutel aromatisiert ca. 5-6 dl Wasser.
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 konfigurieren-stepcol">
                ...
                <div class="row">
                    <div class="col">
                        <div class="konfigurieren-trinkst">
                            So trinkst du <span>30%</span> <b>der empfohlenen Trinkmenge pro Tag</b> mit dem natürlichen Früchtepüree von Eau & Moi.
                        </div>
