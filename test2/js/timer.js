...
function get_timer() {
  ...
  if(date_t > date) {
    ...
    $("#clock").html("<span id='stop'>Бесплатная регистрация закрыта, время истекло!</span>");
    $("#clock2").html("<span id='stop'>Бесплатная регистрация закрыта, время истекло!</span>");
    $("#clock3").html("<span id='stop'>Бесплатная регистрация закрыта, время истекло!</span>");
  }
